...
<% } %>
    ...
    <% if (obj.saved) { %>
      ...
      <div class="edit">
        <% if (!obj.onDatabase && !obj.isSynchronising) { %>
          ...
          <div data-attr="blackgrass" class="js-attr icon icon-blackgrass"></div>
          <div data-attr="season" class="js-attr icon icon-season"></div>
    ...
    <div class="media-body">
      ...
      <div class="attributes">
        <div class="blackgrass"><%= obj.blackgrass %></div>
        <div class="season"><%= obj.season %></div>
